								...
								<div class="formCenter">
									...
									<form method="post" class="woocommerce-ResetPassword lost_reset_password">
										<div class="formHeader">
											<p class="size36 primaryBlue">Enter a new password below.</p>
										</div>
										...
										<p class="woocommerce-form-row woocommerce-form-row--last form-row form-row-last   customInputStyle formInput">
